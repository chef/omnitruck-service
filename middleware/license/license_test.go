...
func TestNew_MissingLicenseRequired(t *testing.T) {
	app := fiber.New()
...
func TestNew_InvalidLicenseProvided(t *testing.T) {
	app := fiber.New()
...
func TestNew_ValidLicenseProvided(t *testing.T) {
	app := fiber.New()
...
func TestNew_NextSkipsLicense(t *testing.T) {
	app := fiber.New()
...
func TestNew_NonRequired_NoLicenseID(t *testing.T) {
	app := fiber.New()
